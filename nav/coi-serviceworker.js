...
// Enables cross-origin isolation on static hosts (GitHub Pages) so SharedArrayBuffer
// is available -> onnxruntime-web WASM can run multi-threaded (big speedup on phones).
...
if (typeof window === 'undefined') {
    ...
    (() => {
        ...
        } else if (coi.shouldRegister() && window.isSecureContext) {
